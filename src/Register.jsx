    ...
    <div className='register'>
      <div className='register_container'>
        ...
        <div className='form'>
          ...
          <h3>Region</h3>
          <p>
          Choose your closest region. If it isn’t available, please select the ‘Other’ option.
          </p>
            <select
              type='date'
              className='register_textBox'
          ...
          <div className='form-field subscription'>
            ...
            />
            <label for='subscription'>Yes, I agree to receive information and offers from Grant Broadcasters and Feb Fit sponsors via email.</label>
          </div>
        </div>
      </div>
